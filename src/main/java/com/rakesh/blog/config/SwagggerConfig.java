...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application API", "This project is developed by Rakesh Mehto", "1.0",
				"Terms of Service", new Contact("Rakesh Mehto", "", ""), "License of APIS", "API license URL",
